...
-- Enable the existing credit system migration
-- The migration file already exists, but we need to ensure the functions are properly created
...
DROP POLICY IF EXISTS "Users can view their own waitlist credits" ON public.waitlist_credits;
